...
p.add_ttl_pulse('ttl_0',WithUnit(200.0,'ms'),WithUnit(1.0,'ms'))
...
DDS = [('DDS_0', WithUnit(0.1, 'ms'), WithUnit(199.9, 'ms'), WithUnit(0.2, 'MHz'), WithUnit(-20,'dBm'), WithUnit(0.0,'deg'),WithUnit(0.0, 'MHz'),no_amp_ramp),
       ('DDS_0', WithUnit(200.0, 'ms'), WithUnit(200.0, 'ms'), WithUnit(100.0, 'MHz'), WithUnit(-20,'dBm'), WithUnit(0.0,'deg'),WithUnit(7.0, 'MHz'),no_amp_ramp),
       ('DDS_1', WithUnit(0.1, 'ms'), WithUnit(500.0, 'ms'), WithUnit(0.2, 'MHz'), WithUnit(-20,'dBm'), WithUnit(0.0,'deg'),WithUnit(0.0, 'MHz'),no_amp_ramp),
       ]
