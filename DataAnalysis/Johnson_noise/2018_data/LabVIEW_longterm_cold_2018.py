...
if __name__ == "__main__":
    ...
    data = np.loadtxt("LabVIEW_longterm_data_cold_2018.txt", delimiter = ",")
    skip = 0
    time = data[:,0][skip:]
    voltage = data[:,1][skip:]
    ...
    # params.add('A', value = 60.0, vary = True)
    # params.add('B', value = 0.001, vary = True)
    # params.add('C', value = 30.0, vary = True)
