...
for i in range(N):
    data = np.loadtxt("scope_"+str(i+10)+".csv", delimiter=",", skiprows=2) #use scope10 and further
    volt = data[:,1]
...
pyplot.plot(frequency_array[1:]/1000.0, combined_fft[1:]) ##skip over the first point
